...
public class CompoundBuilder {
    ...
    public CompoundBuilder addMultiSelectFilterDoesNotEqual(String property, String filter) {
        databasePropertyFilters.add(MultiSelectPropertyFilter
                .of(property, MultiSelectFilterObject.doesNotContainsOf(filter)));
        return this;
    }
    ...
    public CompoundBuilder addMultiSelectFilterIsNotEmpty(String property, boolean isNotEmpty) {
        databasePropertyFilters.add(MultiSelectPropertyFilter
                .of(property, MultiSelectFilterObject.isNotEmptyOf(isNotEmpty)));
        return this;
    }
}
