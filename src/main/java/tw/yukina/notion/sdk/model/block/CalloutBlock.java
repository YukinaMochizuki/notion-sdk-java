...
public class CalloutBlock extends Block implements TextBlock {
    ...
    @NotNull
    public static CalloutBlock of(List<RichText> richTexts){
    ...
    @NotNull
    public static CalloutBlock of(List<RichText> richTexts, Icon icon){
        Callout callout = new Callout();
        callout.setRichTexts(richTexts);
    ...
    @NotNull
    public static CalloutBlock of(List<RichText> richTexts, String emoji){
