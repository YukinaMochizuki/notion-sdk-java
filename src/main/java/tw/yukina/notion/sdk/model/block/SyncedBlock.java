...
public class SyncedBlock extends Block {
    ...
    @NotNull
    public static SyncedBlock of(){
        Synced synced = new Synced();
        SyncedBlock syncedBlock = new SyncedBlock(synced);
        syncedBlock.setType(BlockType.SYNCED_BLOCK);
        return syncedBlock;
    }

    @NotNull
    public static SyncedBlock of(String blockId){
        Synced synced = new Synced();
    ...
    @NotNull
    public static SyncedBlock of(List<Block> children){
        Synced synced = new Synced();
